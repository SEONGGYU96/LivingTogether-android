...
import com.seoultech.livingtogether_android.nok.data.source.NextOfKinDao
...
@Database(entities = [UserEntity::class, DeviceEntity::class, NextOfKin::class, SignalHistoryEntity::class], version = 1)
